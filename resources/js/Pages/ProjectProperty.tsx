...
const ProjectProperty = () => {
  ...
  return (
    ...
    <MainLayout1>
        ...
        {/* <div></div> */}
        {
            screenLG?(
                ...
                <div className=' mt-[7.4375rem] w-[91.25rem] flex justify-start mx-auto'>
                    <Tracer crumbs={[{title:'Home',link:'/'},{title:'Offplan',link:'/project'},{title:'Creek Rise Tower',link:'/project/test'}]}/>
                </div>
            ):
            (
                <div className=' mt-[0.5375rem] w-max flex justify-start ml-[0rem] scale-[0.8] origin-[-140%_0%]'>
                    <Tracer crumbs={[{title:'Home',link:'/'},{title:'Offplan',link:'/project'},{title:'Dubai Marina',link:'/project/test'}]}/>
                </div>
            )
        }
      ...
      <div className='w-min mx-auto mt-[5rem]'>
        <PaymentPlanNF4 screen={screenLG}/>
