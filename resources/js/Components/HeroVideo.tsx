    ...
    <>
        ...
        <div className='h-[calc(100dvh-0rem)] lgx:h-[calc(100dvh+0.25rem)] w-full  absolute top-[1.875rem] lgx:top-0 z-[2] font-[nova]'>
            <div className='relative'>
                ...
                <div className='absolute bg-[#01141666] z-[1] h-[calc(100vh-0rem)] lgx:h-[calc(100vh+0.25rem)] w-full mix-blend-overlay '></div>
                <video  autoPlay loop muted className='h-[calc(100vh-0rem)] lgx:h-[calc(100vh+0.25rem)] w-full object-cover '>
