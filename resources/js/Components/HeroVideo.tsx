...
const HeroVideo = () => {
  ...
  return (
    <>
        <div className='h-[calc(100vh-17.125rem)] w-full relative z-[2] font-[nova]'></div>
        <div className='h-[calc(100vh-10.875rem)] w-full  absolute top-[1.875rem] z-[2] font-[nova]'>
            <div className='relative'>
                ...
                <div className='absolute bg-[#01141666] z-[2] h-[calc(100vh-10.875rem)] w-full mix-blend-overlay '></div>
