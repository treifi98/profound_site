...
const Circle = (props:Props) => {
  return (
    <div className=' hover:animate-bounce select-none cursor-pointer bg-[#00494F] h-[60px] w-[60px] rounded-full border-[1px] border-[#19464B] shadow-[inset_-2.08494px_-2.08494px_3.46797px_-1.15599px_#007580,inset_2.08494px_2.08494px_2.72652px_#002D31] flex justify-center items-center'>
