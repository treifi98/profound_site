  ...
  return (
    <div className='w-[10.89075rem] flex items-center '>
            ...
            <div className='w-[7.030625rem] h-[0.344375rem] bg-[#E6EDED] shadow-[inset_-0.10708875rem_-0.10708875rem_0.17848125rem_#FFFFFF,inset_0.17848125rem_0.17848125rem_0.24987375rem_#B6C3C5] flex justify-start relative'>
                ...
                <div className='absolute top-[-1.87rem] w-[3.83538rem] left-[calc(50%-1.91769rem)] h-[1.25rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] rounded-[6.25rem] shadow-[inset_-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,inset_0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] flex justify-center items-center'>
