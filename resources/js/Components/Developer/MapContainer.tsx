    ...
    <>
        {
            ...
            (
                <div className='w-[375px] h-max shadow-[-0.39291625rem_-0.39291625rem_0.78583125rem_0.196458125rem_#FFFFFF,0.39291625rem_0.39291625rem_0.78583125rem_#BABFBF] overflow-hidden mobil-comp'>
                    ...
                    <div className='w-[345px] flex flex-col mx-auto h-max  '>
                        <div className='w-[345px] max-h-[30rem] h-min  flex flex-wrap justify-between gap-y-[1.13rem] items-start pb-[20px] pt-[15px]'>
                        ...
                        <div className='w-[345px] h-[28.7395rem] mx-auto rounded-[8px] overflow-hidden mb-[15px]'>
                            <Map
                                points={points}
                                changes={changes}
                                rchanges={rchanges}
