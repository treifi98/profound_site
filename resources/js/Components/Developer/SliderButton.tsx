    ...
    <>
        {
            ...
            (
                <div className='min-w-[8rem] h-[3.25rem] flex items-center cursor-pointer group transition-all origin-left  relative '>
                <div className='  w-[57.4px] h-[23px] flex justify-center items-center rounded-[51.893px_0px_0px_51.893px] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5]   float-right'>
                ...
                <div className='flex max-w-0 gap-[7px]  items-center overflow-hidden transition-all group-hover:max-w-[100rem] duration-[0.31s]  left-0 float-right h-[3.25rem] '>
                    {
                        props.options.map((option,index) => {
                            ...
                            if(index == 0){
                                return(
                                    ...
                                    <div className='w-[35px] h-[23px] flex justify-center items-center transition-all border-[#DCE3E3] border-[0.0625rem] rounded-[0.125rem] shadow-[-0.285625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] ml-[0.625rem] hover:shadow-[inset_-0.285625rem_-0.285380625rem_0.456609375rem_#FFFFFF,inset_0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5]'>
                                        <div className='text-grade text-[11.5px]'>
                                            {option}
                                        </div>
                                    </div>
                                )
                ...
                <div className='h-[23px] w-[28px] flex justify-center items-center rounded-[0px_51.893px_51.893px_0px] border-[#DCE3E3] border-[0.0625rem] shadow-[0rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] transition-all'>
                    <img src={arrow} alt="" className='group-hover:rotate-[180deg] transition-all h-[6.9px] w-[4.5px]'/>
                </div>
            </div>
            )
        }
