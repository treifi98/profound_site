    ...
    <>
        {
            ...
            (
                <div className='!w-[100vw] h-max rounded-[0.625rem] bg-[#E6EDED] flex justify-center items-center !font-[nova] py-[1.5rem] shadow-[4px_4px_8px_0px_#BABFBF,-4px_-4px_8px_0px_#FFF]'>
                <div className='w-full h-full flex flex-col-reverse gap-[1.5rem] justify-center items-center  rounded-[0.671375rem] mx-auto'>
                    <div className='flex justify-center items-center w-[20.4375rem] h-max rounded-[0.971875rem] bg-[#E6EDED]  '>
                        <div className='w-[20.4375rem] h-full mx-auto'>
                            <div className='flex flex-col-reverse gap-[1.19rem] w-full h-max items-center'>
                                <div className='flex h-full w-[19.195rem] flex-col gap-[2.19rem] mt-[0.41rem]'>
                                    <DynamicTextWhit textSize='1rem' icon={userIcon} placeHolder='Your full name' imgWrapperWidth='3.290625rem' imgWrapperHeight='2.08375rem' imgWidth='1.11375rem' imgHeight='1.11375rem' textWidth='15.904375rem' textHeight='2.08375rem'/>
                                    <DynamicTextWhit textSize='1rem' icon={emaiIcon} placeHolder='Your email address' imgWrapperWidth='3.290625rem' imgWrapperHeight='2.08375rem' imgWidth='1.26125rem' imgHeight='0.88625rem' textWidth='15.904375rem' textHeight='2.08375rem'/>
                                    <DynamicTextWhit textSize='1rem' icon={uaeFlag} placeHolder='0501234567' imgWrapperWidth='3.290625rem' imgWrapperHeight='2.08375rem' imgWidth='1.480625rem' imgHeight='0.986875rem' textWidth='15.904375rem' textHeight='2.08375rem'/>
                                ...
                                <div className='h-[17.9375rem] w-[20.4375rem] rounded-[0.55rem] shadow-[4.910526275634766px_4.910526275634766px_9.821052551269531px_0px_#BABFBF_inset,-4.910526275634766px_-4.910526275634766px_9.821052551269531px_2.455263137817383px_#FFF_inset] flex justify-center items-center txet-[1rem] leading-[1.5rem] mt-[0.41rem]'>
                                    <div className='text-grade w-[90%]'>
                            ...
                            <div className='mt-[2.195rem] w-[17.9375rem] mx-auto'>
                                <div className='flex gap-[0.54875rem]'>
                        ...
                        <div className='h-[17.9375rem] w-[20.4375rem] rounded-[0.671375rem] shadow-[3.298856496810913px_3.298856496810913px_6.597712993621826px_0px_#BABFBF,-3.298856496810913px_-3.298856496810913px_6.597712993621826px_1.6494282484054565px_#FFF]  flex justify-center items-center !mx-auto'>
                            <div className='h-[16.6875rem] w-[19.0625rem] border-[#CAD4D5] border-[0.0625rem] shadow-[3.298856496810913px_3.298856496810913px_6.597712993621826px_0px_#BABFBF_inset,-3.298856496810913px_-3.298856496810913px_6.597712993621826px_1.6494282484054565px_#FFF_inset] flex justify-center items-center rounded-[0.671375rem]'>
                                <img src={img} alt="" className='w-[18.4375rem] h-[15.75rem] rounded-[0.671375rem]'/>
                            </div>
                        </div>
                </div>
            </div>
