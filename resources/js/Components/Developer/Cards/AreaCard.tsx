...
const AreaCard = () => {
  return (
    <div className='h-[40.5rem] w-[43.4375rem] rounded-[0.9375rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.375rem_-0.375rem_0.75rem_0.1875rem_#FFFFFF,0.375rem_0.375rem_0.75rem_#BABFBF] area-card overflow-hidden'>
