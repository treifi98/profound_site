        ...
        <>
            {
                ...
                <div className='w-[375px] h-max shadow-[-0.39291625rem_-0.39291625rem_0.78583125rem_0.196458125rem_#FFFFFF,0.39291625rem_0.39291625rem_0.78583125rem_#BABFBF] overflow-hidden'>
                    ...
                    <div className=' w-[375px] h-full justify-between  mx-auto'>
                            <div className=' w-[336px] mx-auto'>

                            <div className='w-[336px] mt-[5.2rem] relative rounded-[6.25rem] mx-auto'>
                                <div className='w-[336px] rounded-[6.25rem]'>
                                ...
                                {/* <div className='absolute w-[336px] top-0 left-0 z-[99999999]'>

                                </div> */}

                            </div>
                            <div className='w-[336px] mt-[7rem]'>
