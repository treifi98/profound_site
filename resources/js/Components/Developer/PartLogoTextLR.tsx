                ...
                <div className='w-[375px] h-max flex items-center justify-center bg-[#E6EDED] shadow-[6.286655426025391px_6.286655426025391px_12.573310852050781px_0px_#BABFBF,-6.286655426025391px_-6.286655426025391px_12.573310852050781px_3.1433277130126953px_#FFF] mobil-comp '>
                    <div className='w-[345px] h-max flex flex-col-reverse gap-[0px] mx-auto my-[15px]'>
                        ...
                        <div className='w-[345px] h-[337.11px] flex justify-center items-center mb-[20px]'>
                            <div className='w-[345px] h-[337.11px] flex justify-center items-center rounded-[3.42%_33.76%_2.28%_33.76%] border-[0.0625rem] border-[#DCE3E3] shadow-[inset_-0.294195625rem_-0.294195625rem_0.58839125rem_0.1470975rem_#FFFFFF,inset_0.294195625rem_0.294195625rem_0.58839125rem_#BABFBF]'>
