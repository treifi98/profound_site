...
export const DistanceContainerMobile = (props:Props) => {
  return (
    <div className='w-[21.57825rem] flex justify-center'>
        ...
        <div className='flex items-center relative w-[10.6875rem] h-[2.72375rem] ml-[0rem]' >
            ...
            {/* place holder end */}
            <div className='rounded-full border-[#DCE3E3] border-[0.0625rem] bg-[#E6EDED] absolute w-[2.109375rem] h-[2.109375rem] shadow-[-1.95px_-1.95px_3.13px_#FFFFFF,1.95px_1.95px_2.73px_#B6C3C5] flex justify-center items-center'>
                <img src={attraction} alt="" className=' object-center mt-[-0.5rem] w-[22.46px] h-[20.92px] object-cover'/>
            </div>
