...
import DynamicTag from '../Home/Cards/Common/DynamicTag'
...
const SecondaryInfo = (props:Props) => {
  return (
    <>
        {
            props.screen?(
            ...
            (
                <div className='w-[375px] h-max shadow-[4px_4px_8px_0px_#BABFBF,-4px_-4px_8px_0px_#FFF] overflow-hidden'>
                    ...
                    <div className='w-[345px] mx-auto  h-max min-h-[35.4375rem] py-[1rem] textElementShadow rounded-[8px] border-[1px] border-[#DCE3E3] mt-[20px] mb-[15px] overflow-hidden'>
