            ...
            <div className='w-[87.71875rem] mx-auto mt-[1.625rem]'>
                ...
                <div className='mt-[0.1rem] w-full flex'>
                    ...
                    <div className=' w-[31.4375rem] h-[25.1875rem] rounded-[0.85rem] shadow-[inset_-0.2830525rem_-0.2830525rem_0.45288375rem_#FFFFFF,inset_0.2830525rem_0.2830525rem_0.396273125rem_#B6C3C5] overflow-hidden'>
                        ...
                        <div className='w-[28.8125rem] h-[16.4375rem] mt-[1.34125rem] mx-auto rounded-[0.54375rem] overflow-hidden flex shadow-[-0.47717375rem_-0.47717375rem_0.544065rem_#FFFFFF,0.36271rem_0.36271rem_0.544065rem_#B6C3C5] relative'>
                            <div className='h-full w-[9.625rem] bg-[#E6EDED]'>
                            ...
                            <div className='h-full w-[9.625rem] bg-[#CED7D8]'>
                                <div className='mt-[2.021875rem] mx-auto w-min'>
                            ...
                            <div className='h-full w-[9.625rem] bg-[#9DAFB2]'>
                                <div className='mt-[2.021875rem] mx-auto w-min'>
