...

    {
       ...
       props.screen?(
        ...
        <div className='w-[23.4375rem] h-max shadow-[2.892374277114868px_2.892374277114868px_4.049324035644531px_0px_#B6C3C5,-2.892374277114868px_-2.892374277114868px_4.627798557281494px_0px_#FFF]  overflow-hidden mobil-comp'>
            ...
            <div className=' w-[325px] mx-auto h-[250.64px] flex justify-center items-center shadow-[inset_-4.67px_-4.67px_7.48px_#fff,inset_4.67px_4.67px_6.54px_#B6C3C5] rounded-[0.625rem] border-[1px] border-[#DCE3E3] my-[25px]'>

                <div className='w-[300.28px] h-[226.93px] rounded-[0.625rem] shadow-[-4.67px_-4.67px_7.48px_#fff,4.67px_4.67px_6.54px_#B6C3C5] flex justify-center items-center '>
                    <AboutSwiper width='300.28px' height='226.93px' rounded='0.625rem' scale='0.82'/>
                </div>
            </div>
            {/* <div className='h-[20px]'>
            ...
            <div className='w-min mx-auto mt-[1.138125rem] px-[1rem] text-center shadow-[0px_2.6873440742492676px_2.6873440742492676px_0px_rgba(0,0,0,0.25)] rounded-[4.5375rem] h-[1.69738rem]  flex justify-center items-center bg-custom-gradient mb-[25px] '>
