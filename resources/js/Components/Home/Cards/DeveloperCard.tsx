...
const DeveloperCard = (props:Props) => {
    return (
        <div className=' font-[nova] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.375rem_-0.375rem_0.75rem_0.1875rem_#FFFFFF,0.375rem_0.375rem_0.75rem_#BABFBF] rounded-[0.9375rem] flex justify-center items-center my-[1rem] z-[9999999999999999999] mx-[1.175rem]' style={{ width:props.mainWidth?props.mainWidth:'24.375rem',height:props.mainHeight?props.mainHeight:'30.625rem' }}>
            <div className=' rounded-[0.9375rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.375rem_-0.375rem_0.75rem_0.1875rem_#FFFFFF,0.375rem_0.375rem_0.75rem_#BABFBF]' style={{ width:props.smallerWidth?props.smallerWidth:'21.885rem',height:props.smallerHeigth?props.smallerHeigth:'28.125rem' }}>
                ...
                <div className=' w-full  rounded-[6.25rem] bg-[#E6EDED] shadow-[inset_-0.14793375rem_-0.14793375rem_0.246556875rem_#FFFFFF,inset_0.246556875rem_0.246556875rem_0.345179375rem_#B6C3C5]' style={{ height:props.separatorHeight?props.separatorHeight:'0.3125rem' }}></div>
                ...
                <div className=' mx-auto flex justify-center items-center' style={{ width:props.flexWrapperWidth?props.flexWrapperWidth:'20.0625rem',height:props.flexWrapperHeight?props.flexWrapperHeight:'11.274375rem',gap:props.flexWrapperGap?props.flexWrapperGap:'0.9375rem' }}>
                    <div className=' flex items-end' style={{ width:props.singleWidth?props.singleWidth:'6.0625rem',height:props.singleHeight?props.singleHeight:'11.25rem' }}>
                        <div className=' relative bg-[#E6EDED] border-[#DDE4E4] border-[0.0625rem] rounded-[0.30125rem] shadow-[-0.228939375rem_-0.228939375rem_0.34340875rem_#F7FFFF,0.228939375rem_0.228939375rem_0.34340875rem_#B6C3C5]' style={{ width:props.mainBoxWidth?props.mainBoxWidth:'6.0625rem',height:props.mainBoxHeight?props.mainBoxHeight:'8.1875rem' }}>
                            <div className='absolute flex justify-center items-center rounded-full bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[inset_-0.1895325rem_-0.1895325rem_0.303251875rem_#FFFFFF,inset_0.1895325rem_0.1895325rem_0.265345rem_#B6C3C5] ' style={{ width:props.circleWidth?props.circleWidth:'4.98125rem',height:props.circleHeight?props.circleHeight:'4.98125rem',left:props.circleLeft?props.circleLeft:'0.5rem',top:props.circleTop?props.circleTop:'-2.490625rem' }}>
                            ...
                            <div className=' bg-[#19464B] rounded-[6.25rem] shadow-[inset_-0.25rem_-0.25rem_0.3125rem_#1E6970,inset_0.25rem_0.25rem_0.3125rem_rgba(0,0,0,0.38)] flex justify-center items-center mx-auto' style={{ width:props.tagWidth?props.tagWidth:'5.125rem',height:props.tagHeight?props.tagHeight:'1.5rem',marginTop:props.tagMT?props.tagMT:'1.038125rem' }}>
                    ...
                    <div className=' flex items-end' style={{ width:props.singleWidth?props.singleWidth:'6.0625rem',height:props.singleHeight?props.singleHeight:'11.25rem' }}>
                        <div className=' relative bg-[#E6EDED] border-[#DDE4E4] border-[0.0625rem] rounded-[0.30125rem] shadow-[-0.228939375rem_-0.228939375rem_0.34340875rem_#F7FFFF,0.228939375rem_0.228939375rem_0.34340875rem_#B6C3C5]' style={{ width:props.mainBoxWidth?props.mainBoxWidth:'6.0625rem',height:props.mainBoxHeight?props.mainBoxHeight:'8.1875rem' }}>
                            ...
                            <div className=' w-full flex justify-center items-center' style={{ marginTop:props.button.mainMT?props.button.mainMT:'1.475625rem' }}>
                                ...
                                <ViewAllButtonDynamic text='View Propfile' w={props.button.width?props.button.width:'8.875rem'} h={props.button.height?props.button.height:'2.1875rem'} ml={props.button.mainML?props.button.mainML:'0rem'} textSize={props.button.textSize?props.button.textSize:'1.073125'} img_width={props.button.imgWidth?props.button.imgWidth:'0.569375rem'} imgHeight={props.button.imgHeight?props.button.imgHeight:'0.806875rem'}/>
                            </div>
                {/* <div></div> */}
            </div>
        </div>
