...
const NewsLetter = () => {
  return (
    <div className='w-[91.25rem] h-[8.125rem] bg-[#E6EDED] border-[0.0625rem] border-[#DDE4E4] rounded-[0.480625rem] shadow-[-0.215540625rem_-0.215540625rem_0.32331125rem_#FFFFFF,0.215540625rem_0.215540625rem_0.32331125rem_#AEBBBD] flex justify-center items-center'>
        <div className='flex w-[88.9625rem] mx-auto justify-evenly items-center h-full'>
