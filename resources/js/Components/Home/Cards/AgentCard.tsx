...
const AgentCard = (props:Props) => {
  return (
    <div className='   w-[24.375rem] h-[30.625rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.375rem_-0.375rem_0.75rem_0.1875rem_#FFFFFF,0.375rem_0.375rem_0.75rem_#BABFBF] rounded-[0.9375rem] flex justify-center items-center' style={{ marginTop:props.MT?props.MT:'3.75rem',marginBottom:props.MB?props.MB:'1.875rem' }}>
        ...
        <div className={` w-[${props.w}rem] h-[${props.h}rem] bg-[#E6EDED] border-[1px] border-[#CAD4D5] rounded-[70px_10px] shadow-[-6px_-6px_12px_3px_#FFFFFF,6px_6px_12px_#BABFBF] flex flex-col justify-start items-center`}>
            ...
            <div className='mt-[1.474375rem] flex justify-center'>
                <ViewAllButton w='8.875' h='2.1875' ml='0' text='View Profile'/>
            </div>
