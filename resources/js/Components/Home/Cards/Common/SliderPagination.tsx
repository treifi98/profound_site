        ...
        <div className='flex gap-[0.676875rem]'>
            {
                items.map((item,index) => (
                    <div key={index} className='w-[0.64625rem] h-[0.64625rem] bg-[#E6EDED] rounded-full border-[#DDE4E4] border-[0.0625rem] shadow-[inset_-0.331005rem_-0.331005rem_0.496508125rem_#FFFFFF,inset_0.331005rem_0.331005rem_0.496508125rem_#AEBBBD] relative cursor-pointer flex justify-center items-center' onClick={() => handleClick(index)}>
                        {
                            (active == index) ?(
                                <div key={index+'c'} className='w-[0.4075rem] h-[0.4075rem] bg-custom-gradient_pagination_circle rounded-full'>
