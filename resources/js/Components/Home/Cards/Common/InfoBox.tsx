...
const InfoBox = (props:Props) => {
  ...
  return (
        ...
        <div className={`relative font-[nova] bg-[#E6EDED] border-[1px] border-[#DDE4E4] rounded-[4.8px] ${props.shadow ? props.shadow : 'shadow-[-4.819px_-4.819px_5.49454px_#F7FFFF,3.66303px_3.66303px_5.49454px_#B6C3C5]' } top-0 left-0 w-[${props.w}px] h-[${props.h}px] flex flex-col justify-between  items-center`}>
            <img src={props.img} className={`w-[${props.icon_w ?? '34'}px] h-[${props.icon_h ?? '34'}px]  object-center mt-[${props.icon_t_m ?? '9.64'}px] mb-[${props.icon_b_m ?? '3.05'}px] mx-[${props.icon_x_m ?? '13'}px]`}/>
                <p className='text-[12px] font-[400] w-[70px] text-center text-transparent bg-clip-text bg-gradient-to-b from-[#002E33] via-[#18494E] to-[#00474D] h-[30px] leading-[14.6px]'>
                {props.upperText}
            </p>
