...
const InfoSocial = (props:Props) => {
  return (
    <div className='flex flex-col justify-center items-center gap-[0.7375rem] font-[nova] w-min'>
        ...
        <div className={`w-[${props.w}rem] h-[${props.h}rem] bg-[#E6EDED] border-[#DDE4E4] border-[1px] rounded-[26.5px] shadow-[inset_-3.91242px_-3.91242px_5.86863px_#FFFFFF,inset_3.91242px_3.91242px_5.86863px_#AEBBBD]font-[400] text-[0.6875rem] text-transparent  flex justify-center items-center shadow-[inset_-3.91242px_-3.91242px_5.86863px_#FFFFFF,inset_3.91242px_3.91242px_5.86863px_#AEBBBD]`}>
