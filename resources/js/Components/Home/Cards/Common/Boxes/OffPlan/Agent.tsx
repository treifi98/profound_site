...
const Agent = ({Args}:Args) => {
    return (
        ...
        <div className='group relative cursor-pointer' style={{ width:Args.mainWidth ? Args.mainWidth : '5.3125rem', height:Args.mainHeight ? Args.mainHeight : '6.375rem' }}>
            <div className='bg-[#E6EDED] border-t-[#DCE3E3] border-t-[0.0625rem] border-l-[#DCE3E3] border-l-[0.0625rem] border-r-[#DCE3E3] border-r-[0.0625rem] shadow-[-0.3011875rem_-0.3011875rem_0.34340875rem_#FFFFFF,0.228939375rem_0.228939375rem_0.34340875rem_#B6C3C5]  group-hover:shadow-[inset_-0.3011875rem_-0.3011875rem_0.34340875rem_#FFFFFF,inset_0.228939375rem_0.228939375rem_0.34340875rem_#B6C3C5] duration-[0.1s]' style={{ width:Args.mainWidth ? Args.mainWidth : '5.3125rem', height:Args.mainHeight ? Args.mainHeight : '6.375rem', borderRadius: Args.rounded ? Args.rounded : '0.3125rem' }}>
