                ...
                props.isPrice ? (
                    ...
                    zibras.map((zibra,index)=>(
                            ...
                            (index == 0 || index%2 == 0) ? (
                                <div className='flex justify-center items-center' style={{ width: props.zibraWidth? props.zibraWidth: '100%', height: props.zibraHeight? props.zibraHeight: '1.0625rem' }}>
                                    <div className=' text-[#002d31] font-[400]'style={{ fontSize: props.textSize? props.textSize: '0.78125rem' }}>

                                        {zibra}
                                    </div>
                                </div>
                            ):(
                                <div className='flex justify-center items-center bg-[#002d31]  text-[#fff] font-[400]' style={{ width: props.zibraWidth? props.zibraWidth: '100%', height: props.zibraHeight? props.zibraHeight: '1.0625rem', boxShadow:shadows[1] }}>
                    ...
                    zibras.map((zibra,index) => (
                        ...
                        (index == 0 || index%2 == 0) ? (
                            ...
                            <div className='flex justify-center items-center bg-[#002d31] text-[#fff] font-[400] ' style={{ width: props.zibraWidth? props.zibraWidth: '100%', height: props.zibraHeight? props.zibraHeight: '1.25rem', boxShadow:shadows[1] }}>
