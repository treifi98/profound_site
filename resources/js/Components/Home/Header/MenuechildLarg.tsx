...
const MenueChildLarg = (props:Props) => {
    ...
    return (
        <div className='w-[48.125rem] h-[19.0625rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] rounded-[1.25rem] shadow-[-0.356306875rem_-0.356306875rem_0.7126125rem_#F8FFFE,0.356306875rem_0.356306875rem_0.7126125rem_#B6C3C5] relative' >
            ...
            <div className='text-[1.75rem] text-grade' style={{ width: props.mainTitleWidth ? props.mainTitleWidth : '22.8125rem', height : props.mainTitleHight ? props.mainTitleHight : '5.125' , marginLeft : props.mainTitileML ? props.mainTitileML : '1.5rem', marginTop: props.mainTitileMT ? props.mainTitileMT : (props.button? '0.425rem':'2.9375rem')  }}>
                ...
                </div>
                {
                    props.title2 && (
                        ...
                        <div className=' mt-[0.625rem] w-full text-center' style={props.button?{marginTop:'0.0rem'}:{marginTop:'0.125rem'}}>
                            { props.title2 }
                        </div>
                    )
                }
