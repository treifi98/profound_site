...
const Search = () => {
  ...
  return (
    <>
        <div className='select-none rounded-full relative bg-[#002D31] shadow-[inset_-4px_-4px_5px_-3px_#04626B,inset_4px_4px_6px_#011618] border-[1px] border-[#1F5B62] cursor-pointer flex justify-center items-center w-[3.596rem] h-[3.596rem]' >
