...
const NavHoverCoordinator = ({id}) => {
    ...
    if(id == 1){
        elmnt = (
            <div className='my-[0.625rem] mx-[5%] flex gap-[1.875rem] items-center'>
        ...
        elmnt = (
            <div className='my-[2.125rem] mx-[3%] flex gap-[4.25rem] items-center'>

                    <MenueChildLarg icon={hauseIcon} title1={'Dubai community'} title2='' text="Let Profound Properties guide you towards a bright future in Dubai real estate with our data-driven analysis and insider information. We're always one step ahead, believing that reality is the key factor to making smart decisions. By taking into account real estate behavior, patterns, and changes, we enable our clients to get the best deal possible when buying or selling a property. Our research and preparation help our clients anticipate any future circumstances, ensuring a successful outcome." />

                    <div className='w-[38.36375rem] h-[21.913125rem] flex flex-wrap '>
                        <div className=' mr-[3.125rem] mb-[1.833125rem] w-[10.038125rem] h-[10.038125rem] flex flex-col justify-center items-center border-[#DCE3E3] border-[0.0625rem] gap-[0.9375rem] rounded-[0.625rem] shadow-[-0.30113625rem_-0.30113625rem_0.6022725rem_#FFFFFF,0.30113625rem_0.30113625rem_0.6022725rem_#B1BDBF] cursor-pointer hover:shadow-[inset_-0.30113625rem_-0.30113625rem_0.6022725rem_#FFFFFF,inset_0.30113625rem_0.30113625rem_0.6022725rem_#B1BDBF]'>
                            <div className='w-[6.15125rem] h-[5.5725rem] flex justify-center items-center mt-[0.375rem]'>
        ...
        elmnt = (
            <div className='my-[1.625rem] mx-[4%] flex gap-[4.25rem] items-center'>
                ...
                <div className=' w-[29.365rem] h-[20.625rem] flex flex-wrap'>
                    ...
                    <div className='w-[13.25rem] h-[9.6875rem] rounded-[0.1875rem_1.875rem_0.1875rem_0.625rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF] flex flex-col gap-[1.0625rem] justify-center items-center mb-[1.25rem] cursor-pointer hover:shadow-[inset_-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,inset_0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF]'>
                        <div className='text-[1.75rem] text-grade '>
                            OUR TEAM
                        </div>
                        <div className='text-[1.125rem] text-grade leading-[1.5625rrem] text-center w-[11.6875rem]'>
                    ...
                    <div className='mr-[1.25rem] w-[13.25rem] h-[9.6875rem] rounded-[0.1875rem_0.625rem_0.1875rem_1.875rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF] flex flex-col gap-[1.0625rem] justify-center items-center  cursor-pointer hover:shadow-[inset_-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,inset_0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF]'>
                        <div className='text-[1.75rem] text-grade '>
                            OUR CLIENT
                        </div>
                        <div className='text-[1.125rem] text-grade leading-[1.5625rrem] text-center w-[11.6875rem]'>
                            What they say about us!!!er
                        </div>
                    </div>
                    <div className='w-[13.25rem] h-[9.6875rem] rounded-[0.625rem_0.1875rem_1.875rem] border-[#DCE3E3] border-[0.0625rem] shadow-[-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF] flex flex-col gap-[1.0625rem] justify-center items-center  cursor-pointer hover:shadow-[inset_-0.276666875rem_-0.276666875rem_0.553333125rem_#FFFFFF,inset_0.276666875rem_0.276666875rem_0.553333125rem_#BABFBF]'>
                        <div className='text-[1.75rem] text-grade '>
                            CAREER
                        </div>
                        <div className='text-[1.125rem] text-grade leading-[1.5625rrem] text-center w-[11.6875rem]'>
