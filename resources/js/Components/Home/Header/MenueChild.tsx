...
const MenueChild = (props:Props) => {
    ...
    return (
        <div className='min-w-[24.3125rem] h-[17.8125rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] rounded-[1.25rem] shadow-[-0.356306875rem_-0.356306875rem_0.7126125rem_#F8FFFE,0.356306875rem_0.356306875rem_0.7126125rem_#B6C3C5] relative' >
            ...
            <div className='text-[1.70rem] text-grade w-[calc(100%-1.88125rem)] ml-[1.88125rem] mt-[2.9375rem] text-center' style={props.button?{marginTop:'0.425rem'}:{marginTop:'2.9375rem'}}>
                { props.title1 }
            </div>
            <div className='text-[1.75rem] mt-[0.625rem] text-grade w-[calc(100%-1.88125rem)] min-h-[1.2rem] ml-[1.88125rem] text-center' style={props.button?{marginTop:'0.1rem'}:{marginTop:'0.625rem'}}>
                { props.title2 }
            </div>

            <div className='text-[1.125rem] leading-[1.6875rem] mt-[0.3rem] min-h-[8.4375rem] w-[21.75rem] ml-[1.7625rem] font-[300]' style={props.button?{marginTop:'0.1rem'}:{marginTop:'0.3rem'}}>
                {props.text}
            </div>
            {
                props.button &&
