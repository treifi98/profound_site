...
const Lang = () => {
  ...
  return (
    <div  className='relative lang_effect select-none w-[69px] h-[35px] bg-[#002D31] border-[1px] border-[#1F5B62] rounded-md shadow-[-3.12128px_-3.12128px_5.19175px_-1.73058px_#007580,3.12128px_3.12128px_4.08176px_#011618] text-[#fff] flex justify-between items-center cursor-pointer px-[10px]'>
