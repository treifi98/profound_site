...
const SearchAction = () => {
    ...
    return (
        <>
            <div className='select-none rounded-full relative bg-[#E6EDED] shadow-[inset_-0.455664375rem_-0.455664375rem_1.1391625rem_#F2F9F8,inset_0.455664375rem_0.455664375rem_1.1391625rem_#B6C3C5] cursor-pointer flex justify-center items-center w-[4.324375rem] h-[4.324375rem]' >
                ...
                <div className='relative flex justify-center items-center w-[3.596rem] h-[3.596rem]'>
                    ...
                    {!search ? <div className='absolute shadow-[0.483518125rem_0.483518125rem_1.20879375rem_rgba(12,63,71,0.18),inset_0.483518125rem_0.483518125rem_1.20879375rem_rgba(255,255,255,0.25),inset_-0.483518125rem_-0.483518125rem_1.20879375rem_#B6C3C5,inset_0.483518125rem_0.483518125rem_1.20879375rem_#FFFFFF] w-[3.948125rem] h-[3.948125rem]  bg-[#E6EDED] rounded-full flex justify-center items-center'></div> : ''}
