...
const ButtonSelectMobile = (props:Props) => {
  ...
  return (
    <div className='select-none cursor-pointer group w-[10.575rem] h-[1.75rem] flex border-[0.06rem] border-[#DCE3E3] rounded-[3.13rem] relative' onClick={handleClick} ref={componentRef}>
        <div className='w-[8.25rem] h-[1.75rem] rounded-[3.13rem_0rem_0rem_3.13rem] bg-[#E6EDED]  flex justify-center items-center shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5]' >
            <div className='text-grade text-[0.875rem]'>
                {props.lable}

            </div>
        </div>
        <div className=' relative w-[2.3125rem] group-hover:shadow-[inset_-0.25rem_-0.25rem_0.3125rem_#FFFFFF,inset_0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] h-[1.75rem] bg-[#E6EDED] flex justify-center items-center shadow-[0rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] rounded-[0rem_3.13rem_3.13rem_0rem]' ref={selectHandleRef}>
            <img src={arrow} alt=""  className='w-[0.72125rem] h-[0.310625rem] transition-all' ref={arrowRef}/>
        ...
        </div>
        {
            ...
            <div className='absolute w-[10.575rem] h-[10.375rem] top-[1.75rem] left-[0rem] rounded-[0.63rem] z-[999999]'>
                <div className='w-[10.575rem] h-[9.50rem] bg-[#E6EDED] top-[0rem] mt-[0.875rem] left-[0rem] border-[0.06rem] rounded-[0.63rem] shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] flex justify-center items-center ' onClick={(e) => e.stopPropagation()}>
                    {
...
export default ButtonSelectMobile
//
