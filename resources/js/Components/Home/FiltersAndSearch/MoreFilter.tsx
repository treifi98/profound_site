...
const MoreFilter = (props:Props) => {
  ...
  return (
    <div className='select-none w-[15.75rem] h-[2.25rem] rounded-[3.13rem] relative' >
        <div className=' flex border-[0.06rem] border-[#DCE3E3] w-[13.75rem] rounded-[3.13rem] group cursor-pointer' onClick={handleClick}>
        ...
        {
            openState && (
            <div className='absolute w-[15.75rem] top-[2.25rem] left-[-1rem] rounded-[0.63rem] h-[38rem] z-[999999]'>
