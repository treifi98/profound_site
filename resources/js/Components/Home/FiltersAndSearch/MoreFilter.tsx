...
const MoreFilter = (props:Props) => {
  ...
  return (
    <div className='select-none w-[11.25rem] h-[2.25rem] rounded-[3.13rem] relative' >
        <div className=' flex border-[0.06rem] border-[#DCE3E3] w-[11.25rem] rounded-[3.13rem] group cursor-pointer' onClick={handleClick} style={{ width:props.width? props.width+'rem':'11.25rem' }}>

            <div className='w-[8.0625rem] h-[2.25rem] rounded-[3.13rem_0rem_0rem_3.13rem] bg-[#E6EDED]  flex justify-center items-center shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5]' >
                <div className='text-grade'>
                    {props.lable}

                </div>
            </div>
            <div className='h-[100%2.25rem]'>
                <InElementSeperator width='0.3125rem'/>
            </div>
            <div className=' w-[2.8125rem] group-hover:shadow-[inset_-0.25rem_-0.25rem_0.3125rem_#FFFFFF,inset_0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] h-[2.25rem] bg-[#E6EDED] flex justify-center items-center shadow-[0rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5]  border-[#CAD4D5] rounded-[0rem_3.13rem_3.13rem_0rem]' ref={selectHandleRef}>
                <img src={arrow} alt=""  className='w-[0.66rem] h-[0.65rem] transition-all' ref={arrowRef}/>
            </div>
        </div>
        {
            openState && (
            <div className='absolute w-[15.75rem] top-[2.25rem] left-[-1rem] rounded-[0.63rem] h-[38rem] z-[999999]' style={{ left:props.left?props.left+'rem':'-2.25rem' }}>
