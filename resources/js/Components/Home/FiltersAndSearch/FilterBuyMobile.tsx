...
import { checkSingle } from './CoreFilters/CheckComponentSlice'
import FancyCheckeComponent from './CoreFilters/FancyCheckeComponent'
...
const FilterBuyMobile = () => {
    ...
    const [shwowResidentail,setShowResidential] = useState(true)
    ...
    return (
        ...
        <div className='w-[375px] h-[3.125rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[-5px_-5px_8px_#FFFFFF,5px_5px_7px_#B6C3C5]  relative z-[1] flex justify-center items-center gap-[2rem] '>
            <div>
            <div className='relative z-[4] scale-x-[0.7]'>
                <SelectMobile  options={[{lable:'lowest price',value:'1'}, {lable:'lowest price',value:'1'},{lable:'lowest price',value:'1'},{lable:'one',value:'1'}]} lable='Sort by' id='af' func={() => console.log('d')} mainWidth='8.125' firstWidth='5.3125rem' height='1.625' restWidth='2.825rem' />
            </div>
            </div>
        ...
        <div className='w-[375px] h-0 pb-[0rem] transition-all duration-[0.3s]' ref={cont}>
            ...
            <div className='w-[375px] h-[3.125rem] bg-[#E6EDED] border-[#DCE3E3] border-[0.0625rem] shadow-[-5px_-5px_8px_#FFFFFF,5px_5px_7px_#B6C3C5]  relative z-[1] flex justify-center items-center gap-[2rem] '>
                <div className='w-[95%]  mx-auto h-full flex items-center justify-between gap-[1rem]'>
                    <div className='flex justify-start items-center gap-[20px]  w-[10.575rem]'>
                        <div className='text-grade text-[15px]'>
                            Residential
                        </div>
                        <div className='scale-[0.693]'>
                            <CheckComponent id="buy-residentialCheck" on="on" group='test' off="off"   onFunc={() => setShowResidential(true)} offFunc={() => setShowResidential(false)}/>
                        </div>
                    </div>
                    <div className='flex justify-start items-center gap-[20px]  w-[10.575rem]'>
                        <div className='text-grade text-[15px]'>
                        ...
                        <div className='scale-[0.693]'>
                            <CheckComponent id="buy-comercialCheck" on="on" off="off" group='test' onFunc={() => setShowResidential(false)} offFunc={() => setShowResidential(true)} />
                        </div>
                    </div>
