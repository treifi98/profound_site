  ...
  return (
    <div className='select-none cursor-pointer group w-[13.75rem] h-[2.25rem] flex border-[0.06rem] border-[#DCE3E3] rounded-[3.13rem] relative' onClick={handleClick} ref={componentRef}>
        ...
        </div>
        {
            ...
            <div className='absolute w-[14.75rem] top-[2.25rem] left-[0rem] rounded-[0.63rem] h-[20.875rem] z-[999999] '>
                <div className='select_component w-[13.75rem] bg-[#E6EDED] top-[0rem] mt-[0.875rem] left-[0rem] h-[20rem] overflow-y-hidden border-[0.06rem] rounded-[0.63rem] shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] flex justify-center items-center ' onClick={(e) => e.stopPropagation()}>
                    {
                        <div className='w-[100%] flex flex-col items-center h-[20rem] overflow-y-scroll gap-[0.8125rem] mt-[0.4rem] 'style={openState ? mountedStyle : unmountedStyle}>
                            {
                                props.options.map((option, index) => (
                                    <div className='hover:shadow-[inset_-0.15865375rem_-0.15865375rem_0.264423125rem_#FFFFFF,inset_0.264423125rem_0.264423125rem_0.3701925rem_#B6C3C5] w-[12.2225rem] h-[1.704375rem] flex justify-center items-center rounded-[6.25rem] bg-[#E6EDED] ' onClick={() => handleButtonClick(index,option.value)} key={option.value} ref={refs[index]} >
                                        <div className='text-grade text-[1rem] font-[400]' key={option.value}>
