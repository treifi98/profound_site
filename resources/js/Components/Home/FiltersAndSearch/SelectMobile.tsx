...
const SelectMobile = (props:Props) => {
  ...
  return (
    <div className='select-none cursor-pointer group w-[10.575rem] h-[1.75rem] flex border-[1px] shadow-[-0.285380625rem_-0.285380625rem_0.456609375rem_#FFFFFF,0.285380625rem_0.285380625rem_0.399533125rem_#B6C3C5] border-[#DCE3E3] rounded-[3.13rem] relative z-[2]' onClick={handleClick} ref={componentRef} style={{ width:props.mainWidth? props.mainWidth+'rem':'10.575rem',height:props.mainHeight? props.mainHeight+'rem':'1.75rem' }}>
        <div className='w-[8.25rem] h-full rounded-[3.13rem_0rem_0rem_3.13rem] bg-[#E6EDED]  flex justify-center items-center ' style={{ width:props.firstWidth?props.firstWidth:'8.25rem' }}>
